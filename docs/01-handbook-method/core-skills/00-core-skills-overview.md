...
version: "0.1.0"
tags: ["genai-llm", "core-skills", "logic", "language", "systems-thinking", "sentences"]
...
## Why Core Skills are Foundational

The quality of AI output is directly proportional to the clarity of human input.
Skill gaps lead to:
...
These skills are deeply intertwined. Weakness in any one area can compromise the effectiveness of your AI-assisted workflow.

### 1. Logic

Logic provides the **reasoning framework** for AI to operate within. Without clear logic, AI will make assumptions that lead to plausible but incorrect outputs.
...
-   Establishing invariants that must always hold true.
-   Thinking about cause-and-effect explicitly.

:::tip[Learn more]
**`docs/01-skills/01-logic.md`**
:::
...
-   Avoiding jargon or subjective terms without definitions.
-   Crafting instructions that minimize interpretation variance.

:::tip[Learn more]
**`docs/01-skills/02-language.md`**
:::
...
-   Anticipating scalability, security, and performance implications.
-   Designing for resilience and error handling within the larger whole.
...
## Skill Gaps and Failure Modes

Lack of proficiency in these core skills often leads to common AI-assisted development challenges:

-   **Hallucinations**: AI inventing information or logic.
-   **Scope creep**: AI generating beyond the intended boundaries.
...
-   **Assess your skills**: See `docs/01-skills/05-skill-matrix-and-progression.md`
-   **Understand common pitfalls**: See `docs/01-skills/06-common-skill-gaps.md`

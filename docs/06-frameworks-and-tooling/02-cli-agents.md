...
Example for Aider:
`/add docs/03-method/02-intent-spec.md`
`/add docs/03-method/03-constraint-spec.md`
...
aider src/utils/pricing.ts docs/03-method/02-intent-spec.md docs/03-method/03-constraint-spec.md
